-- Reference/seed data (platform categories), Postgres-portable version of
-- migrations/031_seed_all_platform_categories.sql (drops the SQLite-only
-- PRAGMA foreign_keys statements and uses ON CONFLICT instead of INSERT OR IGNORE).

INSERT INTO platform_categories (category_section, name, display_name, sort_order) VALUES
...
ON CONFLICT (category_section, name) DO NOTHING;
